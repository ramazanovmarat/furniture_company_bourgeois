...
class KitchenDetail extends StatefulWidget {
  ...
  const KitchenDetail({Key? key, required this.kitchen}) : super(key: key);

  @override
  State<KitchenDetail> createState() => _KitchenDetailState();
}
          ...
          child: ListView(
              ...
              children: [
                Row(
                  ...
                  children: [
                    FurnitureCacheImage(height: 600, width: 600, imageUrl: widget.kitchen['image']),
                    const SizedBox(width: 20),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(widget.kitchen['name'], style: GoogleFonts.mPlus1p(fontSize: 40)),
                          const SizedBox(height: 20),
                          Text('${widget.kitchen['price']} ₽', style: const TextStyle(fontSize: 30)),
                          const SizedBox(height: 20),
                          const Divider(),
                          Text(widget.kitchen['description'], style: const TextStyle(fontSize: 20)),
                          const Divider(),
                          const SizedBox(height: 20),
                          SizedBox(
                            height: 40,
